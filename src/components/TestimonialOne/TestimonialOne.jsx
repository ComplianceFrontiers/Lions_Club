  ...
  return (
    <section className={`sec-pad-top testimonials-one ${page ? "sec-pad-bottom" : "testimonials-one--bottom-pd-lg"}`}>
      ...
      <div className='testimonials-one__gallery'>
        <Image className='float-bob-x' src={testi1} alt='' />
        <Image className='float-bob-y' src={testi2} alt='' />
        <Image className='float-bob-x' src={testi3} alt='' />
        <Image className='float-bob-y' src={testi4} alt='' />
        <Image className='float-bob-x' src={testi5} alt='' />
      </div>
      <Container>
